...
echo
node end2end.js "query" '{"channelName":"'"$CHANNEL_NAME"'","chaincodeId":"'"$CHAINCODE_NAME"'","peers":"'"$TARGET_PEER"'","org":"'"$ORG_NAME"'","cfcn":"invoke","cargs":"query,a"}'
echo
echo
